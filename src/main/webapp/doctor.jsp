  	  ...
  	  <div class="row justify-content-center">
             <div class="col-lg-6 text-center">
                <div class="section-title">
                    ...
                    <p>Our team of doctors is comprised of highly qualified professionals dedicated to providing exceptional healthcare. Each physician brings a wealth of experience and expertise in their respective fields, ensuring that patients receive the best possible treatment. They prioritize patient-centered care, taking the time to listen to concerns and understand individual health needs. With a commitment to ongoing education and the latest medical advancements, our doctors are equipped to deliver innovative and effective solutions. You can trust our team to guide you on your journey to health, providing compassionate care at every step.
                    </p>
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="cta-content">
					...
					<a href="appoinment.jsp" class="btn btn-main-2 btn-round-full">Get appoinment<i class="icofont-simple-right  ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
