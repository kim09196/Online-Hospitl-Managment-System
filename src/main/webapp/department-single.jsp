...
<header>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdown03">
         <li><a class="dropdown-item" href="signup.jsp">User</a></li>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					...
					<p>Medicine is vital for maintaining health, encompassing practices that prevent, diagnose, and treat illnesses. Our holistic approach prioritizes both physical and mental well-being, offering a range of services tailored to individual needs. By empowering patients through education and community support, we promote healthy lifestyle choices for long-term wellness.</p>	
<p>In addition to traditional medicine, we advocate for healthy living through education and community support. Our commitment to preventive care empowers patients to take charge of their health, encouraging healthy lifestyle choices that can lead to long-term well-being. By integrating modern medical practices with a focus on overall health, we aim to enhance the quality of life for all our patients.</p>
					...
					<a href="appoinment.jsp" class="btn btn-main-2 btn-round-full">Make an Appoinment<i class="icofont-simple-right ml-2  "></i></a>
				</div>
			</div>
