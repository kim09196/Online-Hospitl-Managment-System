                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active" style="margin-bottom: 15px;">
                            <a href=""><i class="fas fa-file-alt"></i> <span>Patient Details</span></a>
                        </li>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="add_patient_details.jsp" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Patient Details</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDoctorLabel">Delete Patient Details</h5>
