			    ...
			    <li class="nav-item dropdown">
			  	...
			  	<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						...
						<li><a class="dropdown-item" href="appoinment.jsp">Appoinment</a></li>
					</ul>
			  	</li>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>Most trusted Health partner in Sri lanka.</p>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					...
					<div class="content">
						...
						<p class="mb-4">Opthomology</p>
						<a href="department-single.jsp" class="read-more">Learn More  <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<p><p>"Our innovative healthcare system integrates cutting-edge technology and expert medical professionals to provide seamless, personalized care for every patient."</p>.</p>
